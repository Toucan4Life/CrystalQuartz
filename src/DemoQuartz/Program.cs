...
app.UseCrystalQuartz(CreateScheduler,
 new CrystalQuartzOptions { TimelineSpan = TimeSpan.FromMinutes(10), IsReadOnly = false, ClusterConnectionString = "Server=localhost,1433;Database=ApplicationDB;User Id=sa;Password=P@ssw0rd;TrustServerCertificate=True" }); ;
